...
urlpatterns = [
    ...
    path("cost/<int:pk>/edit/",views.plan_cost_edit,name="plan_cost_edit"),
    path("cost/<int:pk>/<int:cost_id>/edit/", views.plan_cost_edit, name="plan_cost_edit_item"),#編集時用
    path("cost/<int:pk>/<int:cost_id>/delete/", views.cost_delete, name="cost_delete"),
